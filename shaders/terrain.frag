...
// Material push constants (reuse existing material system)
...
// Simple directional light for terrain
const vec3 lightDir = normalize(vec3(0.5, 1.0, 0.3)); // Light from above at an angle
const vec3 lightColor = vec3(1.0, 1.0, 1.0);
const float ambientStrength = 0.4; // Slightly higher ambient for terrain
